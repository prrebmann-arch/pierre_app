    ...
    <div class="ap-layout">
      <div class="ap-main">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:14px;">
          ...
          <!-- Poids -->
          <div style="background:var(--bg2);border:1px solid var(--glass-border);border-radius:20px;padding:24px;position:relative;overflow:hidden;">
          ...
          <!-- Bilans -->
          <div onclick="switchAthleteTab('bilans')" style="background:var(--bg2);border:1px solid var(--glass-border);border-radius:20px;padding:24px;cursor:pointer;position:relative;overflow:hidden;transition:all 0.3s cubic-bezier(0.22,1,0.36,1);">
        ...
        <!-- ═══ WEIGHT CHART ═══ -->
        <div style="background:var(--bg2);border:1px solid var(--glass-border);border-radius:20px;padding:24px;">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:14px;">
          <!-- Steps chart -->
          <div style="background:var(--bg2);border:1px solid var(--glass-border);border-radius:20px;padding:22px;">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:14px;">
          <!-- Roadmap -->
          <div onclick="switchAthleteTab('roadmap')" style="background:var(--bg2);border:1px solid var(--glass-border);border-radius:20px;padding:24px;cursor:pointer;transition:all 0.3s cubic-bezier(0.22,1,0.36,1);">
          ...
          <!-- Programme -->
          <div onclick="switchAthleteTab('training')" style="background:var(--bg2);border:1px solid var(--glass-border);border-radius:20px;padding:24px;cursor:pointer;transition:all 0.3s cubic-bezier(0.22,1,0.36,1);">
            <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
          ...
          <!-- Nutrition -->
          <div onclick="switchAthleteTab('nutrition')" style="background:var(--bg2);border:1px solid var(--glass-border);border-radius:20px;padding:24px;cursor:pointer;transition:all 0.3s cubic-bezier(0.22,1,0.36,1);">
            <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
      ...
      <!-- ═══ ACTIVITY SIDEBAR ═══ -->
      <div style="background:var(--bg2);border:1px solid var(--glass-border);border-radius:20px;overflow:hidden;">
